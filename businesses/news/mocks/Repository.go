...
func (_m *Repository) Fetch(ctx context.Context, page int, perpage int) ([]news.Domain, int, error) {
...
func (_m *Repository) GetByID(ctx context.Context, newsId int) (news.Domain, error) {
...
func (_m *Repository) GetByTitle(ctx context.Context, newsTitle string) (news.Domain, error) {
...
// Store provides a mock function with given fields: ctx, newsDomain
func (_m *Repository) Store(ctx context.Context, newsDomain *news.Domain) (news.Domain, error) {
...
func (_m *Repository) Update(ctx context.Context, newsDomain *news.Domain) (news.Domain, error) {
	ret := _m.Called(ctx, newsDomain)
